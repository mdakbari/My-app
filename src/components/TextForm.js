  ...
  return (
    <>
      ...
      >
        ...
        <button className="btn btn-primary bt " onClick={handleUpclick}>
          Convert To Uppercase
        </button>
        <button className="btn btn-primary mx-3 bt" onClick={handleloclick}>
          Convert To lowercase
        </button>
        <button className="btn btn-primary mx-3 bt" onClick={handlecopy}>
          Copy
        </button>
        <button className="btn btn-primary mx-3 bt" onClick={handleliclick}>
          Clear
        </button>
      </div>
      <div
